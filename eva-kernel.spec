...
%prep
%setup -q -n kernel_fedora-kernel
...
if [ -f arch/s390/lib/expoline.o ]; then
  cp -a --parents arch/s390/lib/expoline.o %{buildroot}/lib/modules/%{kverstr}/build
fi
%endif
...
%changelog
* Mon Jun 06 2022 Vaisakh Murali <vaisakhmurali@gmail.com> [1.0]
